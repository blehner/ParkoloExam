...
public class Teherauto implements Jarmu {

    private String rendszam;
    private LocalDateTime belepesiIdo;
    private LocalDateTime kilepesiIdo;
    private boolean fizteve;
    private double parkolasiOradij = 300.0;

    public Teherauto(String rendszam, LocalDateTime belepesiIdo, LocalDateTime kilepesiIdo, boolean fizteve) {
